...
"[project]/apps/web/app/api/dashboard/summary/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$auth$2f$backend$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["backendFetch"])(`/dashboard/summary${search ? `?${search}` : ""}`, {
        method: "GET",
        headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be7c6cd7._.js.map